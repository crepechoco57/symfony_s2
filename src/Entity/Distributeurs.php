...
class Distributeurs
{
    ...
    private ?string $ref_distrib = null;
    ...
    public function getRefDistrib(): ?string
    {
        return $this->ref_distrib;
    }

    public function setRefDistrib(?string $ref_distrib): static
    {
        $this->ref_distrib = $ref_distrib;
